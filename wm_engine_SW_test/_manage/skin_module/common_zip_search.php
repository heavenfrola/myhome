<?PHP
	...
	$_replace_code[$_file_name]['common_zipcode_list']="";
	$_replace_hangul[$_file_name]['common_zipcode_list']="우편번호리스트";
	$_code_comment[$_file_name]['common_zipcode_list']="검색된 우편번호 리스트";
	$_replace_datavals[$_file_name]['common_zipcode_list']="우편번호선택:select_url:우편번호 선택 스크립트 주소 출력;우편번호:zipcode;주소:address;배송불가사유:impossible_reason;";

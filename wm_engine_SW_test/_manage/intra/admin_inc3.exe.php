<?PHP
	...
	$pg_res = preg_replace('/href="([^"]+)"/', 'href="javascript:" onclick="msearch2.open(\'$1\')"', $pg_res);
...
<div id="popupContent" class="popupContent layerPop" style="width:600px;">
	...
	<div id="popupContentArea">
		<div class="box_title first">
			<form id="search" onsubmit="return msearch2.fsubmit(this);">
		...
		<div class="popupContent">
			<table class="tbl_row">
				...
				<tr>
					...
					<td>
						<input type="text" name="reg_code" value="" class="input" size="19" maxlength="6"> <span id="counter2"></span>
					</td>
				</tr>
			</table>
		</div>
	...
	<div class="pop_bottom">
		<span class="box_btn blue"><input type="button" value="<?=__lang_common_btn_confirm__?>" onclick="confirmreg()"></span>
...
<script type="text/javascript">
	...
	function init() {
		...
		interval = setInterval(function() {
			...
			cnt--;
			$("#counter2").html("<img src='<?=$engine_url?>/_manage/image/icon/clock_icon.png' style= 'vertical-align:top; margin-top:8px;'>  잔여시간 <strong>"+padZero(parseInt(lefttime/60))+"</strong>분 <strong>"+padZero(parseInt(lefttime%60))+"</strong>초");
		}, 1000);
	}

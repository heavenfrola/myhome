...
/** Function Library **/
require_once $engine_dir."/_engine/card.allthegate/aegis_Func.php";
...
if( strlen($ERRMSG) == 0 )
{
	...
	****************************************************************************/
	...
	if( !$fp )
	{
		...
		$rSuccYn = "n";
		$result = "연결 실패로 인한 거래실패";
	}
	else
	{
		/** 연결에 성공하였으므로 데이터를 받는다. **/

		$result = "연결에 성공하였으므로 데이터를 받는다.";
	...
	****************************************************************************/
	...
	else
	{
		...
		$rSuccYn = "n";
		$result = "수신 데이터(길이) 체크 에러 통신오류에 의한 승인 실패";
	}
}
else
{

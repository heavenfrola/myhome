		...
		"default": {	// the name of this definition group. It's posisble to have different rules inside the same definition file
			...
			,"KEYWORDS": {
					'': [	// the prefix of thoses items
						 ...
						 * 1 : (optionnal) the string inserted in code ("{@}" being the new position of the cursor, "짠" beeing the equivalent to the value the typed string indicated if the previous )

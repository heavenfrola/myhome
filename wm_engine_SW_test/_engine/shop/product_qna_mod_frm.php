<br><br>
<div id="qna_pwd{상품번호}" style="display:none;">
<form name="qna_pfrm{상품번호}" target="hidden{NOW}" action="{Rdir}/main/exec.php" method="post" onsubmit="return checkQnapwdFrm(this);">
...
<div id="qna_modi{상품번호}" style="display:none;">
<form name="qna_mfrm{상품번호}" target="hidden{NOW}" action="{Rdir}/main/exec.php" method="post" onsubmit="return checkQnaModiFrm(this)">
...
<table border="0" align="center" width="100%" cellpadding="3" cellspacing="0" style="border:3 solid #E3E3E3;">
 <tr>
	...
	<td>{CATE}
	<input type="text" name="title" style="width:100%" value="{제목}" class="qna">
	<input type="checkbox" name="secret" value="Y"{비공개}> 비밀글
	</td>
 </tr>
 <tr>

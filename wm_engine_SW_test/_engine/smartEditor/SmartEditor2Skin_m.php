...
<link href="<?=$engine_url?>/_engine/smartEditor/css/smart_editor2_m.css" rel="stylesheet" type="text/css">
<style type="text/css">
	body { margin: 10px; }
</style>
...
<script type="text/javascript" src="<?=$engine_url?>/_engine/common/jquery/jquery-1.4.min.js" charset="utf-8"></script>
...
<script type="text/javascript" src="<?=$engine_url?>/_engine/smartEditor/js/smarteditor2.js?ver=20200914" charset="utf-8"></script>
    <?php if($editor_code) {?>
	<script type="text/javascript">
	var up_url=root_url+"/main/exec.php?exec_file=smartEditor/upload/upload.exe.php"; // 위치변경불가
	</script>
	<link rel="stylesheet" type="text/css" href="<?=$root_url?>/_data/swfupload/style.css?ver=<?=$ver?>">
	<script type="text/javascript" src="<?=$root_url?>/_data/swfupload/swfupload.js?ver=<?=$ver?>"></script>
	<script type="text/javascript" src="<?=$root_url?>/_data/swfupload/swfupload_handlers.js?ver=<?=$ver?>"></script>
	<script type="text/javascript">
	var upf;
	window.onload = function() { // 업로드 버튼
		if(typeof window.FileReader == 'function') {
			...
			button.style.background = 'url("'+engine_url+'/_engine/smartEditor/img/upload2.png")';
			*/
			...
			input.onchange = function() {
				parent.commonAjaxUpload(input, root_url+'/main/exec.php', {'exec_file':'smartEditor/upload/upload.exe.php', 'wmode':'upload', 'neko_gr':'<?=$neko_gr?>', 'neko_id':'<?=$editor_code?>'}, function(r) {
					if (r.files) {
...
<div id="smart_editor2">
	<div id="smart_editor2_content"><a href="#se2_iframe" class="blind">글쓰기영역으로 바로가기</a>
		<div class="se2_tool" id="se2_tool" style="border:1px solid #dcdcdc; margin:-1px;">
			<div class="se2_text_tool husky_seditor_text_tool">

				<?php if ($editor_code) {?>
				<ul class="se2_multy">
					<li>
						<div id="se2_uploader"></div>
					</li>
				</ul>
				<?php } ?>

				<ul>
					<li class="font_style" onclick="toggleFontControl();"></li>
				</ul>

				<ul class="se2_font_type">
					<li class="husky_seditor_ui_fontName"><button type="button" class="se2_font_family" title="글꼴"><span class="husky_se2m_current_fontName">글꼴</span></button>
						<!-- 글꼴 레이어 -->
						<div class="se2_layer husky_se_fontName_layer" style="opacity:0.9;">
							<div class="se2_in_layer" style="width:100%;">
					...
					<li class="husky_seditor_ui_fontSize"><button type="button" class="se2_font_size" title="글자크기"><span class="husky_se2m_current_fontSize">크기</span></button>
						<!-- 폰트 사이즈 레이어 -->
						<div class="se2_layer husky_se_fontSize_layer" style="opacity:0.9;">
							<div class="se2_in_layer" style="width:100%;">
				...
				<ul>
					<li class="se2_pair husky_seditor_ui_fontColor">
						<span class="selected_color husky_se2m_fontColor_lastUsed" style="background-color:#4477f9"></span>
						<!--
						<span class="husky_seditor_ui_fontColorA"><button type="button" title="글자색" class="se2_fcolor"><span>글자색</span></button></span>
						-->
						<span class="husky_seditor_ui_fontColorB"><button type="button" title="더보기" class="se2_fcolor_more"><span class="_buttonRound">더보기</span></button></span>
						<!-- 글자색 -->
						<div class="se2_layer husky_se2m_fontcolor_layer" style="display:none; opacity:0.9;">
							<div class="se2_in_layer husky_se2m_fontcolor_paletteHolder" style="width:100%;">
								<div class="se2_palette husky_se2m_color_palette">
									...
									<button type="button" title="더보기" class="se2_view_more husky_se2m_color_palette_more_btn" style="width:0; height:0;"><span>더보기</span></button>
									...
									<div class="se2_palette2 husky_se2m_color_palette_colorpicker">
										<div class="se2_color_set">
											<span class="se2_selected_color"><span class="husky_se2m_cp_preview" style="background:#e97d81"></span></span><input type="text" name="" class="input_ty1 husky_se2m_cp_colorcode" value="#e97d81"><button type="button" class="se2_btn_insert husky_se2m_color_palette_ok_btn" title="입력"><span>입력</span></button>
										</div>
					...
					<li class="husky_seditor_ui_subscript" style="display:none;"><button type="button" title="아래첨자" class="se2_sub"><span class="_buttonRound">아래첨자</span></button></li>
				</ul>
				...
				<ul>
					...
					<li class="husky_seditor_ui_lineHeight" style="display:none;"><button type="button" title="줄간격" class="se2_lineheight" ><span class="_buttonRound">줄간격</span></button>
						<!-- 줄간격 레이어 -->
		...
		<div class="se2_conversion_mode">
			<button type="button" class="se2_inputarea_controller husky_seditor_editingArea_verticalResizer" title="입력창 크기 조절" style="display:none;"><span>입력창 크기 조절</span></button>
	...
	<div id="se2_img_preview">
        <iframe
            name="se2_img_preview_frm"
            id="se2_img_preview_frm"
            src="exec.php?exec_file=smartEditor/upload/preview.php&editor_code=<?=$editor_code?>&contentId=<?=$contentId?>"
            border="no"
            frameborder="no"
            noresize width="100%"
            height="95px"
...
<script type="text/javascript">
var toggleFontControl = function() {
    jQuery('.se2_font_type').toggle();
    jQuery('.font_style').toggleClass('active');

	setTimeout(function(){
		var sw = jQuery('#se2_tool').width();
		var sw2 = jQuery('#se2_tool').width()/2+1;
		jQuery('.se2_font_type').css('width',sw+'px');
		jQuery('.husky_se_fontName_layer').css('width',sw+'px').css('left','-1px');
		jQuery('.husky_se_fontSize_layer').css('width',sw+'px').css('left','-'+sw2+'px');
		jQuery('.husky_se2m_fontcolor_layer').css('width',sw+'px').css('left','-107px');
	}, 1);
}
</script>

<?
	 ...
	 *
	 ******************************************************/
	$TeleditBinPath = $engine_dir."/_engine/card.danal/bin";
	 ...
	 *  AMOUNT 	: 결제 금액
	 ******************************************************/
	$cfg['danal_cp_id']="9010S18212";
	$cfg['danal_cp_pwd']="wisa";
	$cfg['danal_item_code']="22S28S0000";
	if($_use['danal_cp_id_type'] == 2) {
		$cfg['danal_cp_id']="A010S18213 ";
	}
	if($_use['danal_cp_id_type'] == 3) {
		$cfg['danal_cp_id'] = $cfg['danal_mstcp_id'];
		$cfg['danal_cp_pwd'] = $cfg['danal_mstcp_pwd'];
	}
	...
	function GetCIURL($IsUseCI,$CIURL) {
		 ...
		 * Default Danal CI
		 */
		$URL = "http://ui.teledit.com/Danal/Teledit/Web/images/customer_logo.gif";
